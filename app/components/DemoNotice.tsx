...
export const DEMO_NOTICE_TEXT = '⚠️ 本サイトは「Mercari AI Agent Hackathon」提出用に作成したデモ・モックサイトです。株式会社メルカリおよび同社サービスとは一切関係ありません。';
...
export const DemoNoticeCard: React.FC<{ className?: string }> = ({ className = '' }) => (
  <section className={`demo-notice-card ${className}`} aria-label="ご注意：本サイトについて">
    <img
      ...
      alt="ご注意。本サイトはMercari AI Agent Hackathon提出用のデモ・モックサイトです。株式会社メルカリおよび同社サービスとは一切関係ありません。"
