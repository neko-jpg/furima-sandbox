...
export const NotificationView: React.FC = () => {
  ...
  return (
    <div className="shop-scrollbar flex-1 overflow-y-auto bg-[var(--shop-bg)]" data-testid="notification-view">
      <div className="mx-auto max-w-[980px] px-4 pb-12 md:px-7"><div className="flex items-center justify-between border-b border-[var(--shop-border)] py-5"><h1 className="text-lg font-black text-white">お知らせ</h1><button type="button" className="text-xs font-bold text-[var(--shop-blue)]">ニュース</button></div>
        ...
        <button type="button" className="mt-5 flex w-full items-center justify-between rounded-lg border border-[var(--shop-blue)]/50 bg-[#122b3a] px-4 py-3 text-sm font-bold text-[var(--shop-blue)]">おすすめキャンペーンを見る<ChevronRight className="h-4 w-4" /></button>
      </div>
