...
const subcategories: Record<string, string[]> = {
  'ゲーム・おもちゃ・グッズ': ['すべて', 'テレビゲーム', 'ゲームコントローラー', 'トレーディングカード', 'キャラクターグッズ', 'フィギュア', 'タレントグッズ', 'おもちゃ', '木製知育玩具', 'ボードゲーム', 'パズル・ボードゲーム', 'ドール・お人形遊び', 'ミリタリー', 'シール・ステッカー', 'ミニチュア', '手品', 'パーティグッズ'],
  'ホビー・楽器・アート': ['すべて', 'ミニカー・模型', 'コレクション', 'フィギュア', 'アート'],
  '本・雑誌・漫画': ['すべて', '本', '雑誌', '漫画', '絵本・児童書', '文学・小説', 'ビジネス・経済', 'ビジネス・実用書', 'ノート・文具'],
  ファッション: ['すべて', 'トップス', 'ワンピース', 'ジャケット・アウター', 'パンツ', 'バッグ', 'ハンドバッグ', 'ショルダーバッグ', '靴', 'スニーカー', 'サンダル', 'メンズ小物', 'アクセサリー'],
  'スマホ・タブレット・パソコン': ['すべて', 'スマートフォン本体', 'スマートデバイスセット', 'タブレット', 'PC・タブレット', 'ノートPC', 'デスクトップPC', 'PC周辺機器'],
  'テレビ・オーディオ・カメラ': ['すべて', 'オーディオ', 'ヘッドホン', 'ワイヤレスヘッドホン', 'カメラ', 'ミラーレスカメラ', 'コンパクトデジタルカメラ'],
  '生活家電・空調': ['すべて', '生活家電', 'キッチン家電', 'コーヒーメーカー', 'トースター'],
  'スポーツ': ['すべて', 'スポーツ用品', 'アメリカンフットボール', 'テニス用品'],
  'アウトドア・釣り・旅行用品': ['すべて', 'スポーツ用品', 'アメリカンフットボール', 'テニス用品'],
  'キッチン・日用品・その他': ['すべて', '調理器具', 'カトラリー', 'キッチンツール'],
  '家具・インテリア': ['すべて', '家具', 'ソファ・ソファベッド', 'インテリア', 'アロマ・ディフューザー', '壁掛けアート・時計', '照明', '間接照明', 'デスクライト'],
  'ベビー・キッズ': ['すべて', 'ベビー服', 'キッズ服', 'おもちゃ', 'ぬいぐるみ', 'パーティー・イベント用品', 'ベビーカー', 'チャイルドシート'],
};
